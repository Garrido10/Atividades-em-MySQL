...
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Genday", 2323, 1333,  "amarelo", 1);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Lupin", 3322, 1444, "azul", 2);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Forb", 1000, 3000, "verde", 3);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Zurk", 9990, 2200, "vermelho", 4);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Sert", 123, 1480, "cinza", 5);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Mick", 3232, 1500,  "lilas", 3);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Zorry", 332, 4000, "laranja", 2);
insert into tb_personagem (nomePersonagem, poderDefesa, poderAtaque, cor, classe_id) values ("Mork", 336, 350, "marrom", 1);
